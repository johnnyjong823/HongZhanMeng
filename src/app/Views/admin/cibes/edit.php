...
<div class="flex items-center mb-6">
    ...
    <div>
        <h2 class="text-2xl font-bold text-[#212529]">編輯 Cibes 品牌</h2>
        <p class="text-[#6C757D]">編輯 Cibes 品牌資料</p>
    </div>
</div>

<form id="cibes-form" action="<?= url('/admin/cibes/update/' . $item['id']) ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" rows="6"
                                  class="w-full px-4 py-2 border border-[#DEE2E6] rounded-lg focus:ring-2 focus:ring-[#4A90D9] focus:border-[#4A90D9] text-[#212529]"
                                  placeholder="請輸入內容描述（選填）"><?= htmlspecialchars($item['content'] ?? '') ?></textarea>
                    </div>
                </div>
            </div>
